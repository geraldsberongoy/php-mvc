...
abstract class BaseTeacherController extends AbstractController
{
    ...
    /**
     * Get common template variables for teacher views
     */
    ...
    /**
     * Render teacher template with base variables
     */
    protected function renderTeacher(string $template, array $data = []): Response
    {
